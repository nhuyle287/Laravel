                        ...
                        <div style="float: left">
                            <div class="input-group mb-3 d-flex flex-nowrap">
                                ...
                                @can('medicine-delete')
                                    ...
                                    <form action="{{ route('admin.medicines.destroy-select') }}" method="POST">
                                        @csrf
                                ...
                                <div class="clearfix" style="margin-left: 0.25rem; margin-bottom: 0">
                                    ...
                                    @can('medicine-create')
                                        <div class="create float-left">
                                            <a href="{{route('admin.medicines.create')}}" class="btn btn-success "><i
                    ...
                    <div id="customer-table">
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <th>{{ __('medicine.producer') }}</th>
                                <th class="test"></th>
                            </tr>
                            </thead>
                            <tbody>
                            @include('admin.medicine.search-row')
                            </tbody>
                        </table>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function fetch_data(page, amountRow, query) {
                $.ajax({
                    type: 'POST',
                    url: '{{ route('admin.medicines.search-row') }}?page=' + page + '&amount=' + amountRow + '&key=' + query,
            ...
            $("#showRow").on('change', function () {
                var amountRow = $("#showRow :selected").val();
                var url = '{{ route('admin.medicines.index').'?amount=:amount' }}';
